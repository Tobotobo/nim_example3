...
type
  ...
  DIContainer* = ref object of Object
    dic: Table[int, ServiceCreator]

proc create*(): DIContainer =
  let diContainer = DIContainer()
  diContainer.dic = initTable[int, ServiceCreator]()
  return diContainer

let container = create()

proc add*[T](self: DIContainer, clazz:Class[T], creator: ServiceCreator) =
  self.dic[clazz.getId()] = creator

proc add*[T](clazz:Class[T], creator: ServiceCreator) =
